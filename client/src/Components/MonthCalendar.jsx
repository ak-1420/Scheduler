        ...
        return (
            <div className="month_calendar">
                ...
                }
                {
                    ...
                    days.map ((val,indx) => {
                       return(
                        <CalendarBox filterId = {this.props.filterId} setToast={this.props.setToast} displaySchedules={this.props.displaySchedules} updateSchedule={this.props.updateSchedule} month={month} year={year} week={weekDays} fpd={frontPaddingDays} bpd={backPaddingsDays} nd={numberOfDays} fd={firstDay} isWeekBox = {false} key={indx} id = {indx} day={val} weekday={weekDays[indx % 7]} /> 
                       );
                    })
                }
